...
public class FileUploadServlet extends HttpServlet {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -8478047461267930574L;
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		String fileUrl = "http://localhost:8082/uploaded-files/" + filePart.getSubmittedFileName();
		...
		response.getOutputStream().println("<p>Upload another file <a href=\"http://localhost:8082/Em_homepage.html\">here</a>.</p>");
